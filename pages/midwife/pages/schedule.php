...
// ===== FETCH INFANTS =====
$infants = [];
$infant_api = "http://localhost:8000/infant/get";
...
// ===== FETCH VACCINES =====
$vaccines = [];
$vaccine_api = "http://localhost:8000/vaccine/get";
...
// ===== FETCH MIDWIVES =====
$midwives = [];
$midwife_api = "http://localhost:8000/midwife/get";
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["create_vaccination"])) {
    ...
    $url = "http://localhost:8000/schedule/add";
    $options = [
        "http" => [
